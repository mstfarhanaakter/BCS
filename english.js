...
function addSection(sectionNumber, questions = []) {
  ...
  card.innerHTML = `
    <h2 class="accordion-header d-flex justify-content-between align-items-center" id="heading${sectionNumber}">
      ...
      <div class="d-flex gap-3 p-0 m-0 ">
        <button class="btn btn-warning p-0 m2-1  btn-check-correct btn-sm">Check corrects</button>
    ...
    <div id="section${sectionNumber}" class="accordion-collapse collapse" aria-labelledby="heading${sectionNumber}">
      <div class="accordion-body">
        <div class="section-summary text-center mb-2" style="display:none;">
          <b>Correct correct:</b> <span class="correct">0</span> 
          <br> 
          <b>Correct correct:</b> <span class="wrong">0</span>
        </div>
    ...
    qCard.innerHTML = `
        ...
        <div id="q${sectionNumber}_${idx}" class="collapse">
          <div class="card-body" data-correct="${q.correct}">
            ...
            `).join('')}
            <div class="correct-explanation d-none">
  ...
  const checkBtn = card.querySelector('.btn-check-correct');
  ...
  checkBtn.addEventListener('click', e => {
    ...
    bodies.forEach(body => {
      ...
      const explanation = body.querySelector('.correct-explanation');
      let corrected = false;
      opts.forEach((opt, i) => {
...
const bcs46Questions = [
  ...
  },
  {
    ...
    correct: null,
    explanation: "Correct correct should be 'quiet'."
  },
  {
